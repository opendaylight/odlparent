...
public class SystemStateFailureException extends Exception {
    private static final long serialVersionUID = 2024307948995818320L;

    private final BundleDiagInfos bundleDiagInfos;

    public SystemStateFailureException(String message, Throwable cause, BundleDiagInfos bundleDiagInfos) {
