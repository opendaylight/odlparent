...
public final class TestBundleDiag {
    ...
    // in infrautils.ready, which already uses this, but which will be changed ASAP to use @OsgiService BundleDiag
    ...
    public static void checkBundleDiagInfos(BundleContext bundleContext, long timeout, TimeUnit timeoutUnit)
        ...
        } catch (org.opendaylight.odlparent.bundlestest.SystemStateFailureException e) {
