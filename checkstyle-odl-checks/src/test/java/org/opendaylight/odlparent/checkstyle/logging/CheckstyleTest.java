 ...
 */
package org.opendaylight.odlparent.checkstyle.logging;
...
import org.opendaylight.odlparent.checkstyle.logging.LogMessageExtractorCheck;
...
public class CheckstyleTest {
    ...
    public void testLoggerChecks() throws Exception {
        verify(CheckLoggingTestClass.class, true,
                ...
                "35: Log message placeholders count is incorrect",
                "44: Log message contains string concatenation");
    }
    ...
    public void testLogMessageExtractorCheck() throws Exception {
        ...
        assertEquals("src/test/java/org/opendaylight/odlparent/checkstyle/logging/CheckLoggingTestClass.java:26:\"foo {} {}\"", reportLines.get(0));
        // TODO assertEquals("src/test/java/org/opendaylight/odlparent/checkstyle/logging/CheckLoggingTestClass.java:27:\"foo {} bar {}\"", reportLines.get(1));
    }
