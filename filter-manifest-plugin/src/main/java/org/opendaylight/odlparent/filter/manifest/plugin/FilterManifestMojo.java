...
public class FilterManifestMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        try (InputStream is = Files.newInputStream(inputFile.toPath())) {
            ...
            throw new MojoFailureException("Failed to read input " + inputFile, e);
        }
        ...
        for (String attr : retainedAttributes) {
            ...
            if (value != null) {
                ...
                LOG.debug("Skipping non-present attribute {}", attr);
            }
        }
        ...
        try (OutputStream os = Files.newOutputStream(outputFile.toPath())) {
            ...
            throw new MojoFailureException("Failed to write output " + outputFile, e);
        }
    }
}
