...
final class DependencyResolver {
     ...
     * @return collection of dependency descriptors for features detected (out of provided list, not sub-dependencies)
     ...
     * @return collection of feature dependency descriptor being resolved
     * @throws MojoExecutionException if any dependency resolution fails
     */
