...
import static org.opendaylight.odlparent.features.test.plugin.PaxOptionUtils.profileVmOptions;
...
public final class TestFeaturesMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException {
        ...
        LOG.info("Options: {}", Arrays.asList(options));
