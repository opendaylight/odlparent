        ...
        try {
            URL.setURLStreamHandlerFactory(protocol -> {
                try {
                    ...
                    return URLStreamHandler.class.cast(handlerClass.getDeclaredConstructor().newInstance());
            ...
            // warn only, assuming it's a subsequent invocation of same mojo instance
            LOG.warn("URL stream handler factory is already set");
        }
    }
}