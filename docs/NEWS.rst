...
* awaitility `4.2.1 → 4.2.1 <https://raw.githubusercontent.com/awaitility/awaitility/master/changelog.txt>`__
...
* maven-surefire-plugin `3.3.1 → 3.4.4 <https://issues.apache.org/jira/secure/ReleaseNote.jspa?projectId=12317927&version=12354945>`__
