...
Version 10.0.6
--------------
This is a security bug-fix upgrade from version 10.0.5.
...
~~~~~~~~~~~~~~~~~~~~~~~~
* Checkstyle 10.4 → 10.8.1, release notes:
...
* commons-net `3.8.0 → 3.9.0 <https://commons.apache.org/proper/commons-net/changes-report.html#a3.9.0>`__

* Dropwizard Metrics 4.2.13 → 4.2.17, release notes:
...
* Jackson 2.13.4 → 2.14.2, release notes:
...
* Karaf `4.3.8 → 4.3.9 <https://issues.apache.org/jira/secure/ReleaseNote.jspa?projectId=12311140&version=12352383>`__

* Netty 4.1.84 → 4.1.89, release notes:
...
* cyclonedx-maven-plugin 2.7.1 → 2.7.5, release notes:
...
* maven-dependency-plugin 3.3.0 → 3.5.0, release notes:
  * `3.4.0 <https://issues.apache.org/jira/secure/ReleaseNote.jspa?projectId=12317227&version=12351068>`__
  * `3.5.0 <https://issues.apache.org/jira/secure/ReleaseNote.jspa?projectId=12317227&version=12352602>`__
...
* maven-plugin-plugin 3.6.2 → 3.7.0, release notes:
  ...
  * `3.7.1 <https://issues.apache.org/jira/secure/ReleaseNote.jspa?projectId=12317820&version=12352745>`__
...
* spotbugs-maven-plugin 4.7.2.2 → 4.7.3.2, release notes:
  * `4.7.3.0 <https://github.com/spotbugs/spotbugs-maven-plugin/releases/tag/spotbugs-maven-plugin-4.7.3.0>`__
...
Version 10.0.5
--------------
This is a security bug-fix upgrade from version 10.0.4.
...
Version 10.0.4
--------------
This is a bug-fix upgrade from version 10.0.3.
...
* Dropwizard Metrics `4.2.11 → 4.2.12 <https://github.com/dropwizard/metrics/releases/tag/v4.2.10>`__
...
* Karaf `4.3.7 → 4.3.8 <https://issues.apache.org/jira/secure/ReleaseNote.jspa?projectId=12311140&version=12351577>`__
...
* SpotBugs 4.7.1 → 4.7.3, release notes:
  ...
  * `4.7.2 <https://github.com/spotbugs/spotbugs/releases/tag/4.7.3>`__
...
* maven-bundle-plugin 5.1.5 → 5.1.8, release notes:
  * `5.1.6 <https://issues.apache.org/jira/secure/ReleaseNote.jspa?projectId=12310100&version=12351722>`__
...
* maven-site-plugin 3.11.0 → 3.12.1, release notes:
  * `3.12.0 <https://issues.apache.org/jira/secure/ReleaseNote.jspa?projectId=12317923&version=12351142>`__
  * `3.12.1 <https://issues.apache.org/jira/secure/ReleaseNote.jspa?projectId=12317923&version=12351751>`__
...
Version 10.0.3
--------------
This is a bug-fix upgrade from version 10.0.2.
