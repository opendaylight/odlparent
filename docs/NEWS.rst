...
Version 9.0.16
--------------
This is a bug-fix upgrade from version 9.0.15.
...
* Jackson 2.13.2 → 2.13.4, release notes:
  * `2.13.3 <https://github.com/FasterXML/jackson/wiki/Jackson-Release-2.13.3>`__
  * `2.13.4 <https://github.com/FasterXML/jackson/wiki/Jackson-Release-2.13.4>`__
...
* ThreeTen `1.5.0 → 1.5.1 <https://github.com/skyscreamer/JSONassert/blob/master/CHANGELOG.md#version-151---742022>`__
...
* maven-jar-plugin `3.2.0 → 3.3.0 <https://issues.apache.org/jira/secure/ReleaseNote.jspa?projectId=12317526&version=12351126>`__
