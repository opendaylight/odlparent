...
* ``single-feature-test`` now properly contributes to JaCoCo execution profiles.
  See `ODLPARENT-274 <https://jira.opendaylight.org/browse/ODLPARENT-274>`__ for more information.
...
* Karaf `4.3.3 → 4.3.4 <https://issues.apache.org/jira/secure/ReleaseNote.jspa?projectId=12311140&version=12350547>`__
...
* pmd-maven-plugin `3.14.0 → 3.15.0 <https://www.mail-archive.com/announce@maven.apache.org/msg01019.html>`__
