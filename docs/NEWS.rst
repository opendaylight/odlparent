...
Plugin upgrades
~~~~~~~~~~~~~~~
* build-helper-maven-plugin `3.0.0 → 3.1.0 <https://github.com/mojohaus/build-helper-maven-plugin/issues?q=is%3Aissue+milestone%3A3.1.0+is%3Aclosed>`__
...
Version 6.0.7
-------------
This is a security/bug-fix upgrade from version 6.0.6.
