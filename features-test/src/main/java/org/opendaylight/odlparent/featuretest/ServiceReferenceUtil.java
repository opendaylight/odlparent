 ...
 */
public final class ServiceReferenceUtil {

    private ServiceReferenceUtil() { }

    public static Map<String, Object> getProperties(ServiceReference<?> serviceRef) {
    ...
    public static List<String> getUsingBundleSymbolicNames(ServiceReference<?> serviceRef) {
