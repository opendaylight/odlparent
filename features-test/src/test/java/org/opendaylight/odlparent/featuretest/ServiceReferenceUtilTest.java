...
public class ServiceReferenceUtilTest {
    ...
    public void testGetUsingBundleSymbolicNames() {
        assertThat(new SingleFeatureTest().getUsingBundleSymbolicNames(getServiceReference())).isEmpty();
    }

    @Test
    public void testGetProperties() {
        assertThat(new SingleFeatureTest().getProperties(getServiceReference())).containsExactly(
                "property1", "value1",
