...
public class ServiceReferenceUtilTest {
    ...
    public void testGetUsingBundleSymbolicNames() {
        assertThat(ServiceReferenceUtil.getUsingBundleSymbolicNames(getServiceReference())).isEmpty();
    }

    @Test
    public void testGetProperties() {
        assertThat(ServiceReferenceUtil.getProperties(getServiceReference())).containsExactly(
                "property1", "value1",
