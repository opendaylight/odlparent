...
/**
 * Unit test of helper methods in {@link SingleFeatureTest}.
 * @author Michael Vorburger.ch
 */
public class SingleFeatureTestUnitTest {

    @Test
    public void testGetClasses() {
        assertThat(new SingleFeatureTest().getClasses("org.awaitility").collect(Collectors.toList()))
    ...
    public void testGetInnerClasses() {
        List<Class<?>> innerClasses = new SingleFeatureTest()
            .getClasses(getClass().getPackage().getName()).collect(Collectors.toList());
