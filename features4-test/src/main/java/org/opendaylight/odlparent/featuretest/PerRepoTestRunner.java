...
public class PerRepoTestRunner extends ParentRunner<PerFeatureRunner> {
    ...
    protected List<PerFeatureRunner> runnersFromFeatures(
        ...
        for (final Feature f : featureList) {
            // If the features have more than one feature, ignore same-named feature
            // This skips aggregator features which we don't care about and which are expensive to test
