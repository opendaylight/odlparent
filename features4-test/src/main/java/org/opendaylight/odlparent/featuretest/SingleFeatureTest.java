...
public class SingleFeatureTest {
    ...
    public Option[] config() throws IOException {
        ...
        return new Option[] {
            ...
            CoreOptions.systemProperty(BUNDLES_DIAG_SKIP_PROP).value(
                    System.getProperty(BUNDLES_DIAG_SKIP_PROP)),
            CoreOptions.systemProperty(BUNDLES_DIAG_TIMEOUT_PROP).value(
                    System.getProperty(BUNDLES_DIAG_TIMEOUT_PROP)),
