...
public class SingleFeatureTest {
    ...
    public Option[] config() throws IOException {
        return new Option[] {
            ...
            mvnLocalRepoOption(),
            /* TODO Enable the auditing setup
            features("mvn:org.apache.karaf.features/standard/" + getKarafVersion() + "/xml/features", "wrap"),
            wrappedBundle(maven("org.awaitility", "awaitility").versionAsInProject()), // req. by bundles-test
            mavenBundle(maven("org.opendaylight.odlparent", "bundles4-test").versionAsInProject()),
            */
