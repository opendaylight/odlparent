...
public final class ResourceSupport {
    ...
    /**
     * Register a {@link AutoCloseable} resource with this registry.
     *
    ...
    void close() {
        ...
        synchronized (this) {
            switch (state) {
                ...
                case Open(var resources) -> {
                    LOG.debug("Closing instance {} with {} registrants", uuid, resources.size());
        ...
        it.forEachRemaining(ResourceSupport::closeDefensively);
    }
